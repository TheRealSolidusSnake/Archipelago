...
class MGOnline(WebWorld):
    theme = "partyTime"
    tutorials = [Tutorial(
        "Multiworld Setup Guide",
        "A guide for setting up MGS: Masala Garden Salad.",
        "English",
        "setup_en.md",
        "setup/en",
        ["SDMichaud", "TheRealSolidusSnake"],
    )]
...
class MGSWorld(World):
    ...
    def generate_early(self) -> None:
        ...
        self.logic_difficulty = self.options.logic_difficulty.value
    ...
    def create_items(self) -> None:
        ...
        if self.run_goal == 2: # dog tag collection
            for _ in range(self.dogtag_goal):
                self.item_pool.append(self.create_item('Dogtag'))
            for _ in range(self.dogtag_extra):
                self.item_pool.append(self.create_item_useful('Dogtag'))
        self.item_pool.append(self.create_item('Progressive Key Card'))
        self.item_pool.append(self.create_item('Progressive Key Card'))
        self.item_pool.append(self.create_item('Progressive Key Card'))
        self.item_pool.append(self.create_item('Progressive Key Card'))
        self.item_pool.append(self.create_item('Progressive Key Card'))
        ...
        self.item_pool.append(self.create_item_useful('Camera'))
